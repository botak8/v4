...
clear
echo -e " $COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e " $COLOR1│$NC \e[33m               • SSH PANEL MENU •       ${NC}"
echo -e " $COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌───────────────────────────────────────────────┐${NC}"
$COLOR1 │$NC   \e[33m[1]  • CREATE SSH ACCOUNT ${NC}"
$COLOR1 │$NC   \e[33m[2]  • TRIAL SSH          ${NC}"
$COLOR1 │$NC   \e[33m[3]  • RENEW SSH          ${NC}"
$COLOR1 │$NC   \e[33m[4]  • DELETE SSH         ${NC}"
$COLOR1 │$NC   \e[33m[5]  • CHECK LOGIN SSH    ${NC}"
$COLOR1 │$NC   \e[33m[6]  • MEMBER SSH         ${NC}"
$COLOR1 │$NC   \e[33m[7]  • DELETE USER EXP    ${NC}"
$COLOR1 │$NC   \e[33m[8]  • LOCK SSH           ${NC}"
$COLOR1 │$NC   \e[33m[9]  • UNLOCK SSH         ${NC}"
