...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/botak8/v4/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/botak8/v4/main/ip | grep $MYIP | awk '{print $2}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/botak8/v4/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "${BIYellow}□ License Limit       = ORDER ${GREEN}( NULL )${NC}"
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( BROTHERTUNNEL )${NC}"
echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}BROTHER TUNELING${NC}"
echo -e "${BICyan} │"
